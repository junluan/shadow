...
int main(int argc, char const* argv[]) {
  std::string deploy_file = "models/ssd/adas_model_finetune_reduce.prototxt";
  std::string model_file = "models/ssd/adas_model_finetune_reduce.caffemodel";
  ...
  WriteProtoToBinary(shadow_net, root, model_name + "_finetune_reduce_model");
